export default function MCPPage() {
  return (
    <>
      ...
      <h2>Endpoints</h2>
      <pre><code>{`GET  https://api.aetherdb.cloud/mcp/tools   # list available tools
POST https://api.aetherdb.cloud/mcp/call    # call a tool`}</code></pre>

      <h2>List tools</h2>
      <pre><code>{`GET https://api.aetherdb.cloud/mcp/tools
...
{ "tools": [
  ...
  { "name": "upsert_vector",  "description": "Upsert a vector embedding"  }
      ...
      <h2>Call a tool</h2>
      <pre><code>{`POST https://api.aetherdb.cloud/mcp/call
...
{ "result": { "rows": [{ "count": "142" }] } }`}</code></pre>
      ...
      <pre><code>{`POST https://api.aetherdb.cloud/agent/provision
Content-Type: application/json
