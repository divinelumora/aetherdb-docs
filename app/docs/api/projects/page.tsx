export default function ProjectsPage() {
  return (
    <>
      ...
      <h2>List projects</h2>
      <pre><code>{`GET https://api.aetherdb.cloud/db/projects
Authorization: Bearer <token>`}</code></pre>

      <h2>Create project</h2>
      <pre><code>{`POST https://api.aetherdb.cloud/db/projects
...
{ "name": "My App", "description": "Production database" }`}</code></pre>
      ...
      <pre><code>{`DELETE https://api.aetherdb.cloud/db/projects/{id}
Authorization: Bearer <token>`}</code></pre>

      <h2>List API keys</h2>
      <pre><code>{`GET https://api.aetherdb.cloud/db/projects/{id}/keys
Authorization: Bearer <token>
...
{ "keys": [{ "id": 1, "name": "prod-key", "key": "adb_live_xxx", "created_at": "..." }] }`}</code></pre>
      ...
      <pre><code>{`POST https://api.aetherdb.cloud/db/projects/{id}/keys
Authorization: Bearer <token>
Content-Type: application/json
...
{ "id": 1, "name": "production-key", "key": "adb_live_xxxxxxxxxxxx" }`}</code></pre>
      ...
      <pre><code>{`DELETE https://api.aetherdb.cloud/db/projects/{id}/keys/{keyId}
Authorization: Bearer <token>`}</code></pre>

      <h2>Using API keys</h2>
      <pre><code>{`// Use exactly like a JWT token
GET https://api.aetherdb.cloud/tenant/schema
