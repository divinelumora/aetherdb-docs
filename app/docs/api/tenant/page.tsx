export default function TenantPage() {
  return (
    <>
      ...
      <pre><code>{`GET https://api.aetherdb.cloud/tenant/info
...
// Response 200:
{
  ...
  "port": 5432
      ...
      <h2>Get schema</h2>
      <pre><code>{`GET https://api.aetherdb.cloud/tenant/schema
Authorization: Bearer <token>
  ...
  "tables": [
    {
      ...
      <h2>Create table</h2>
      <pre><code>{`POST https://api.aetherdb.cloud/tenant/tables
Authorization: Bearer <token>
...

{
  ...
  "columns": [
    ...
    { "name": "price", "type": "NUMERIC", "nullable": true  }
      ...
      <h2>Run a query</h2>
      <pre><code>{`POST https://api.aetherdb.cloud/tenant/query
Authorization: Bearer <token>
Content-Type: application/json
...
{ "rows": [...], "rows_affected": 0 }`}</code></pre>
      ...
      <h2>Insert a row</h2>
      <pre><code>{`POST https://api.aetherdb.cloud/tenant/insert
Authorization: Bearer <token>
Content-Type: application/json
...
{ "id": 2, "message": "row inserted" }`}</code></pre>
      ...
      <h2>AI query</h2>
      <pre><code>{`POST https://api.aetherdb.cloud/tenant/ai/query
Authorization: Bearer <token>
Content-Type: application/json
